(set-info :min-time 901.049486258)
; Start decls (1)
(declare-fun |c::main::1::IN!0@1#0| () (_ FloatingPoint 8 24))
; End decls
; Start constraints (3)
(assert (fp.lt |c::main::1::IN!0@1#0| (fp #b0 #x7e #b10011001100110011001100)))
(assert (fp.lt (fp #b1 #x7e #b10011001100110011001100) |c::main::1::IN!0@1#0|))
