(set-info :min-time 900.875522384)
; Start decls (3)
...
(assert (fp.lt ((_ to_fp 11 53) roundNearestTiesToEven |c::main::1::a!0@1#1|)
       (fp #b0 #b10000000011 #x4000000000000)))
(assert (fp.lt (fp #b1 #b10000000011 #x4000000000000)
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   ...
                   (fp.mul roundNearestTiesToEven
                           ...
                           (fp.mul roundNearestTiesToEven
                                   |c::main::1::a!0@1#1|
                                   |c::main::1::b!0@1#1|)))))
  (not (fp.leq a!1 (fp #b0 #x83 #b11100000000000000000000)))))
; End constraints
(check-sat)
