(set-info :min-time 901.046456661)
; Start decls (1)
(declare-fun |c::main::1::IN!0@1#0| () (_ FloatingPoint 8 24))
; End decls
; Start constraints (3)
(assert (fp.lt |c::main::1::IN!0@1#0| (fp #b0 #x7d #b10011001100110011001100)))
(assert (fp.lt (fp #b1 #x7d #b10011001100110011001100) |c::main::1::IN!0@1#0|))
...
(let ((a!16 (fp.add roundNearestTiesToEven
                    (fp.add roundNearestTiesToEven
                            ...
                            (fp.neg (fp.div roundNearestTiesToEven a!4 a!6)))
                    (fp.neg a!15))))
  (not (fp.lt ((_ to_fp 11 53) roundNearestTiesToEven a!16)
              (fp #b0 #b01111111011 #x9999999999999)))))))))))))))
; End constraints
(check-sat)
