(set-info :min-time 900.895901006)
; Start decls (1)
(declare-fun |c::main::1::IN!0@1#0| () (_ FloatingPoint 8 24))
; End decls
; Start constraints (3)
(assert (fp.lt |c::main::1::IN!0@1#0| (fp #b0 #x7f #b00000000000000000000000)))
(assert (fp.lt (fp #b1 #x7f #b00000000000000000000000) |c::main::1::IN!0@1#0|))
