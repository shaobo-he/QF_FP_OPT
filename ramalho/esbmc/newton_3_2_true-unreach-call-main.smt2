(set-info :min-time 901.063290312)
; Start decls (18)
...
(assert (fp.lt (fp #b1 #x7d #b10011001100110011001101) |c::main::main::1::IN@1!0&0#0|))
(assert (fp.lt |c::main::main::1::IN@1!0&0#0| (fp #b0 #x7d #b10011001100110011001101)))
