(set-info :min-time 901.051494951)
; Start decls (13)
...
(assert (fp.lt (fp #b1 #x7e #b00110011001100110011010) |c::main::main::1::IN@1!0&0#0|))
(assert (fp.lt |c::main::main::1::IN@1!0&0#0| (fp #b0 #x7e #b00110011001100110011010)))
